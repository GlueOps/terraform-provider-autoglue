...
func TaintsDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"key": schema.StringAttribute{
				...
				MarkdownDescription: "Exact key",
			},
			"q": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "key contains (case-insensitive)",
				MarkdownDescription: "key contains (case-insensitive)",
			},
			...
			"value": schema.StringAttribute{
				...
				MarkdownDescription: "Exact value",
			},
		},
	}
}

type TaintsModel struct {
