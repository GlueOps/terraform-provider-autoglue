...
package resource_cluster_glueops_load_balancer_attachment
...
func ClusterGlueopsLoadBalancerAttachmentResourceSchema(ctx context.Context) schema.Schema {
...
type ClusterGlueopsLoadBalancerAttachmentModel struct {
