...
package resource_cluster_bastion_attachment
...
func ClusterBastionAttachmentResourceSchema(ctx context.Context) schema.Schema {
...
type ClusterBastionAttachmentModel struct {
